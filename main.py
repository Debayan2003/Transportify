...
GROUND = pygame.transform.scale(pygame.image.load(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'MainGround.png')), (WIDTH, HEIGHT))

BLACKBG = pygame.transform.scale(pygame.image.load(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'BlackBG.png')), (WIDTH, HEIGHT))
...
OVER_RED = pygame.transform.scale(pygame.image.load(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'OverRed.png')), (16*HW, 2.25*HH))

OVER_BLUE = pygame.transform.scale(pygame.image.load(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'OverBlue.png')), (16*HW, 2.25*HH))

RED_BULLET = pygame.transform.scale(pygame.image.load(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'RedBullet.png')), (BW, BH))
RED_BULLET_MASK = pygame.mask.from_surface(RED_BULLET)

BLUE_BULLET = pygame.transform.scale(pygame.image.load(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'BlueBullet.png')), (BW, BH))
BLUE_BULLET_MASK = pygame.mask.from_surface(BLUE_BULLET)

CLICK = pygame.mixer.Sound(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'Click.mp3'))

BLAST = pygame.mixer.Sound(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'Blast.mp3'))

TANK_BLAST = pygame.mixer.Sound(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'TankBlast.mp3'))

BIG_BLAST = pygame.mixer.Sound(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'BigBlast.mp3'))

SHOT = pygame.mixer.Sound(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'Shot.mp3'))

INTRO = pygame.mixer.Sound(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'Intro.mp3'))
INTRO.set_volume(0.6)
 
INGAME = pygame.mixer.Sound(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'InGame.mp3'))
INGAME.set_volume(0.6)

OUTRO = pygame.mixer.Sound(os.path.join('Python Programs\Games\Game of Tanks\Assets', 'Outro.mp3'))
